...
title AFTERBURN - Vertical 4K.bat
...
:use_py
py -3 "%~dp0launch.py" --aspect vertical --width 2160 --height 3840 --quality ultra %*
set "afterburn_exit=%errorlevel%"
goto finish

:use_python
python "%~dp0launch.py" --aspect vertical --width 2160 --height 3840 --quality ultra %*
set "afterburn_exit=%errorlevel%"
